      ...
      <div className="ml-12">
        <div className="md:flex items-center justify-between">
          <div className="md:w-[478px]">
            <div className="text-md inline-flex border-[#222]/10 px-3 py-1 rounded-lg tracking-tight">South India Premier Astrologer
            </div>
            <h1 className="text-3xl md:text-3xl font-bold tracking-tight bg-gradient-to-b from-black to-[#001E80] text-transparent bg-clip-text mt-6"> Discover Your Divine Path Through Ancient Wisdom</h1>
